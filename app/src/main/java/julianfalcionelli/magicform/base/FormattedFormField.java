...
public class FormattedFormField extends FormField
{
	...
	public FormattedFormField(Activity activity, int viewId, String regularExp, String replacement)
	{
		super(activity, viewId);
		setupFormatter(regularExp, replacement);
	}
	...
	public String getFormattedValue(String rawValue)
	{
		...
		while (formattedValue.length() > 0 && !Character.isDigit(formattedValue.charAt(formattedValue.length() - 1)))
		{
